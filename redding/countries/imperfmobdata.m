...
global alpha sigma theta epsilon LL LLwest LLeast F;
...
[a_i,b_i,abtradesh,aconverge,bconverge,xtic]=solveabCtyClosed(param,observe,dclosed,dist0,nobs);
...
print -dpdf graphs/cnty_closed.pdf;
...
set(gca,'fontsize',8);
hold on;
line([2.6 2.6],[0 4],'LineStyle','-','Color','black','LineWidth',2);
hold off;
% Wage;
subplot(3,2,2);
C=contourf(XXw,YYw,ZZw,5);
...
print -dpdf graphs/cnty_open.pdf;
...
h=histc(dL,bin);
h=h./sum(h);
h1=histc(dL(Iwest==1),bin);
h1=h1./sum(h1);
h0=histc(dL(Ieast==1),bin);
h0=h0./sum(h0);
bar(h1);
hold on;
ylabel('Probability','FontSize',8);
title('Panel A : Population West','FontSize',8);
axis([0 20 0 0.6]);
set(gca,'fontsize',8);
...
hold on;
ylabel('Probability','FontSize',8);
title('Panel B : Population East','FontSize',8);
axis([0 20 0 0.6]);
set(gca,'fontsize',8);
set(gca, 'XTickLabel',[bbin(1) bbin(5) bbin(10) bbin(15) bbin(20)],'XTick',[1 5 10 15 20]);
hold off;
...
h=histc(dr,bin);
h=h./sum(h);
h1=histc(dr(Iwest==1),bin);
h1=h1./sum(h1);
h0=histc(dr(Ieast==1),bin);
h0=h0./sum(h0);
bar(h1);
hold on;
ylabel('Probability','FontSize',8);
title('Panel C : Land Rents West','FontSize',8);
axis([0 20 0 0.6]);
set(gca,'fontsize',8);
set(gca, 'XTickLabel',[bbin(1) bbin(5) bbin(10) bbin(15) bbin(20)],'XTick',[1 5 10 15 20]);
hold off
...
hold on;
ylabel('Probability','FontSize',8);
title('Panel D : Land Rents East','FontSize',8);
axis([0 20 0 0.6]);
set(gca,'fontsize',8);
set(gca, 'XTickLabel',[bbin(1) bbin(5) bbin(10) bbin(15) bbin(20)],'XTick',[1 5 10 15 20]);
hold off;
...
hold on;
ylabel('Probability','FontSize',8);
title('Panel E : Immobile Welfare West','FontSize',8);
axis([0 20 0 0.6]);
set(gca,'fontsize',8);
set(gca, 'XTickLabel',[bbin(1) bbin(5) bbin(10) bbin(15) bbin(20)],'XTick',[1 5 10 15 20]);
...
hold on;
ylabel('Probability','FontSize',8);
title('Panel F : Incorrect Immobile Welfare East','FontSize',8);
axis([0 20 0 0.6]);
set(gca,'fontsize',8);
set(gca, 'XTickLabel',[bbin(1) bbin(5) bbin(10) bbin(15) bbin(20)],'XTick',[1 5 10 15 20]);
...
print -dpdf graphs/cnty_open_hist.pdf;
