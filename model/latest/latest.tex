...
\begin{align*}
    w_{ckt}^{IV} = \sum_{s}^{S} \gamma_{ks} \bar{\phi}_{cs} A_{st}
\end{align*}

where $\bar{\phi}_{cs}$ is the  share of occupation $k$ in sector $s$ in city $c$. This will give us the following first stage regression:
