...
We now take logs and difference the equation to eliminate the level shift. Recalling our definition of $Z_c^{- \theta} = (\gamma \Phi_c)^{- \theta} (T_c)^{\theta}$, we get the following estimation equation:
